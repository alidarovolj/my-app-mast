...
export default function MainContent({navigation}) {
  ...
  async function getAxios() {
    var res = await axios.get('https://api.unsplash.com/photos?client_id=UxQcyiv7djwaIznmB6G73bYjldVCcICcUT4HZpscGcI');
  ...
  return (
    ...
    <SafeAreaView>
      ...
      <Button title="FetchData" onPress={getAxios}/>
      <FlatList data={fetchedData} renderItem={( { item } ) => (
        <Image style={[ t.w40, t.h40, t.flex, t.flexRow ]} source={{ uri: item.urls.regular }} />
      )} />
